# Links the canonical brainstorm-vision skill into this repo's Claude and Codex
...
# the links.
#
# Usage:  pwsh .\link-skill-brainstorm-vision.ps1
...
foreach ($skillDirectory in $skillDirectories) {
    ...
    $link = Join-Path $skillDirectory 'brainstorm-vision'
