...
| UC3 | [L132](../ai-mail-foundation-vision.md#L132) | S1 | IND | CAP6 | — | INV3 | Catch the costly life-admin miss before it happens and ask what to do. |
| UC4 | [L136](../ai-mail-foundation-vision.md#L136) | S1 | IND | CAP6 | — | INV3 | Know deadlines/obligations inferred from the email itself — no manual due dates. |
...
| UC15 | [L178](../ai-mail-foundation-vision.md#L178) | S1 | IND (→EXT) | CAP5 | — | INV1 | Nudge before a key account or promising lead slips through the cracks. |
...
| UC21 | [L204](../ai-mail-foundation-vision.md#L204) | S1 | IND (→EXT) | CAP13 | CAP4, CAP15 | INV1 | Run a scheduling negotiation in the background; user sees only the result to confirm. |
...
| UC28 | [L230](../ai-mail-foundation-vision.md#L230) | S1 | IND | CAP9 | — | — | Know the user's normal to catch the forged invoice / changed-bank-details note. |
| UC29 | [L234](../ai-mail-foundation-vision.md#L234) | S1 | IND | CAP9 | — | INV1 | Slow the urgent-money traps and warn before any money moves, not after. |
...
| UC48 | [L316](../ai-mail-foundation-vision.md#L316) | S1 | MGR | CAP18 | CAP12, CAP14 | INV5, INV10 | A complete lasting record of the assistant's own decisions — auditable, not staff-surveillance. |
...
| UC50 | [L326](../ai-mail-foundation-vision.md#L326) | S1 | TM | CAP14 | CAP5 | — | Escalate a beyond-me message to the right specialist with the full picture, one nod. |
...
| UC58 | [L363](../ai-mail-foundation-vision.md#L363) | S1 | IND | CAP10 | — | — | See at a glance where every open item stands and whose court it's in. |
| UC59 | [L368](../ai-mail-foundation-vision.md#L368) | S1 | MGR | CAP14 | CAP10 | INV10 | See the team's whole work-state — aged items, whose court — without clocking people. |
...
| UC64 | [L397](../ai-mail-foundation-vision.md#L397) | S1 | IND (→EXT) | CAP13 | CAP4 | INV1, INV9 | Let it carry a whole multi-round exchange to its finish, coming back for decisions/approval. |
...
| UC68 | [L419](../ai-mail-foundation-vision.md#L419) | S1 | STAFF | CAP16 | CAP7 | INV11 | Leaving a job, hand over the whole role's mail already understood — open threads, promises, what's owed, relationships. |
...
| UC82 | [L487](../ai-mail-foundation-vision.md#L487) | S1 | MGR | CAP18 | — | INV5 | Meet a legal hold or data-access request fully and defensibly, from a complete trustworthy record. |
...
| UC96 | [L557](../ai-mail-foundation-vision.md#L557) | S3 | IND | CAP6 | — | INV13 | Hold standing obligations as live commitments and surface each in time — from the date drawing near, not any message arriving. |
...
| UC99 | [L578](../ai-mail-foundation-vision.md#L578) | S3 | IND | CAP6 | — | INV13 | Hold the user to fine print built to turn against them — surface the auto-renewal / step-up window while it's still open. |
...
| UC101 | [L591](../ai-mail-foundation-vision.md#L591) | S3 | IND | CAP6 | — | INV13 | Hold the legal obligations no one sends a reminder for — license, filing, inspection — and surface each in time to act. |
...
| UC111 | [L660](../ai-mail-foundation-vision.md#L660) | S2 | IND | CAP6 | CAP11, CAP1 | INV13 | Lift the real ask hidden in a casual channel — a voice note that means "invoice by Friday," a photo that's a receipt — out as a task or filed doc. |
