...
- **Scope** is the UC's *native rung* — the lowest scope item (`S#`) among the vision points it realizes, per [vision-index.md](vision-index.md)'s UC→rung mapping (S1 < S2 < S3). A UC that realizes **no** vision point carries `Scope = —` and is listed under `Unpromised UCs` in [vision-index.md](vision-index.md) (S9 coverage signal).
...
| UC4   | [L137](../ai-mail-foundation-vision.md#L137) | —    | IND             | CAP6    | —            | see UC3            | Merged into UC3 — automatic due-date/obligation inference folded into the same costly-miss watch.                                                    |
...
| UC6   | [L145](../ai-mail-foundation-vision.md#L145) | —    | IND             | CAP6    | —            | INV3               | Resurface the right thing (booking, warranty) the moment it's needed, unprompted.                                                                    |
| UC7   | [L149](../ai-mail-foundation-vision.md#L149) | —    | IND             | CAP2    | —            | INV3               | Mail sorted into sensible places rather than one undifferentiated pile.                                                                              |
...
| UC9   | [L156](../ai-mail-foundation-vision.md#L156) | —    | IND             | CAP4    | —            | INV1, INV9         | The dreaded reply pre-drafted in the user's voice — tweak and nod.                                                                                   |
...
| UC12  | [L167](../ai-mail-foundation-vision.md#L167) | —    | IND             | CAP1    | —            | INV4, INV7, INV8   | Lean on the briefing yet always able to open and read everything — never locked out.                                                                 |
...
| UC16  | [L182](../ai-mail-foundation-vision.md#L182) | —    | IND             | CAP7    | —            | INV6, INV11        | Remember relationship context across years, even data living outside email.                                                                          |
...
| UC18  | [L191](../ai-mail-foundation-vision.md#L191) | —    | IND             | CAP8    | —            | INV2, INV3         | Old mail made safe and tidy — dead stuff set aside, valuable preserved and in order.                                                                 |
...
| UC20  | [L198](../ai-mail-foundation-vision.md#L198) | —    | IND             | CAP10   | —            | INV3               | Stand watch over the whole picture and surface patterns the user never knew to ask about.                                                            |
| UC21  | [L205](../ai-mail-foundation-vision.md#L205) | —    | IND (→EXT)      | CAP13   | —            | see UC64           | Merged into UC64 — scheduling negotiation is one instance of carry-the-exchange-to-finish.                                                           |
...
| UC27  | [L227](../ai-mail-foundation-vision.md#L227) | —    | IND             | CAP11   | —            | INV7               | Help one click away inside the existing inbox, not a new place to move into.                                                                         |
...
| UC29  | [L236](../ai-mail-foundation-vision.md#L236) | —    | IND             | CAP9    | —            | see UC28           | Merged into UC28 — urgent-money-pressure intervention folded into the money-fraud guard.                                                             |
...
| UC31  | [L241](../ai-mail-foundation-vision.md#L241) | —    | IND             | CAP9    | CAP12        | INV4               | Explain in plain words why something smells wrong, so the user learns to spot it.                                                                    |
...
| UC36  | [L261](../ai-mail-foundation-vision.md#L261) | —    | IND             | CAP4    | —            | INV1, INV9         | Cold-start drafts (intro, reconnection, pitch) assembled in the user's voice.                                                                        |
...
| UC39  | [L275](../ai-mail-foundation-vision.md#L275) | —    | IND             | CAP17   | CAP9         | INV4               | A patient plain-words helper to just ask "is this real?" / "what does this want?".                                                                   |
...
| UC44  | [L297](../ai-mail-foundation-vision.md#L297) | —    | TM              | CAP14   | CAP2         | INV3               | File the shared inbox the team's way; when unsure leave in the common pile; learn from re-assignment.                                                |
...
| UC47  | [L312](../ai-mail-foundation-vision.md#L312) | —    | IND             | CAP12   | CAP5         | INV4               | Show everything it did and why, each with a plain reason — never a black box.                                                                        |
...
| UC53  | [L340](../ai-mail-foundation-vision.md#L340) | —    | IND             | CAP2    | CAP7         | INV1, INV2         | Notice duplicates and offer to tidy — always shown, never a copy thrown away silently.                                                               |
...
| UC56  | [L353](../ai-mail-foundation-vision.md#L353) | —    | TM (→PIC)       | CAP14   | —            | INV1, INV11        | Pull a colleague in for just this moment with a scoped view; drop them back out after.                                                               |
...
| UC60  | [L373](../ai-mail-foundation-vision.md#L373) | —    | IND (→EXT)      | CAP1    | CAP9         | INV2, INV3         | Doorkeeper tells the real first-contact from mass pitch; holds (never deletes) the rest, overrulable.                                                |
...
| UC62  | [L386](../ai-mail-foundation-vision.md#L386) | —    | IND             | CAP7    | CAP11        | INV11              | Recognise one Contact across addresses and apps — one relationship thread, never half-blind.                                                         |
...
| UC67  | [L413](../ai-mail-foundation-vision.md#L413) | —    | IND             | CAP8    | CAP7         | INV6               | Useful from day one — learned from the whole existing archive, not only new mail.                                                                    |
...
| UC71  | [L433](../ai-mail-foundation-vision.md#L433) | —    | IND (→EXT)      | CAP13   | CAP9         | INV1, INV9         | When the counterparty has their own assistant, the two settle the drudge; each principal is handed the result to approve.                            |
...
| UC77  | [L464](../ai-mail-foundation-vision.md#L464) | —    | IND (→EXT)      | CAP9    | —            | INV9               | Prove an incoming message truly is from who it claims, and that the user's own are provably theirs — impersonation stops both ways.                  |
...
| UC82  | [L489](../ai-mail-foundation-vision.md#L489) | —    | MGR             | CAP18   | —            | see UC48           | Merged into UC48 — legal-hold / data-access response folded into the assistant-decision record.                                                      |
...
| UC84  | [L495](../ai-mail-foundation-vision.md#L495) | —    | IND             | CAP18   | CAP12        | —                  | Keep a hold on what leaves — a message that can't be forwarded on, expires, or whose access can be pulled back later.                                |
...
| UC89  | [L518](../ai-mail-foundation-vision.md#L518) | —    | IND             | CAP1    | CAP5         | —                  | Make sure the genuinely warm message isn't lost in the pile — surfaced quietly, never dressed up as an engagement trick.                             |
...
| UC92  | [L536](../ai-mail-foundation-vision.md#L536) | —    | IND (→EXT)      | CAP4    | CAP1         | INV1, INV9         | Stay a real human to an audience at scale — surface the ones worth answering, draft warm replies in the user's voice.                                |
| UC93  | [L542](../ai-mail-foundation-vision.md#L542) | —    | IND             | CAP10   | CAP5, CAP4   | —                  | Keep a whole job-search campaign straight — every application's stage, no missed reply, prep pulled together, graceful chasing.                      |
...
- **S1** (native): 63 UCs — all not listed under S2 / S3 / — below.
...
- **— (unpromised)** (realize no `V#` — the S9 unpromised-UC signal; listed under `Unpromised UCs` in [vision-index.md](vision-index.md)): UC4, UC6, UC7, UC9, UC12, UC16, UC18, UC20, UC21, UC27, UC29, UC31, UC36, UC39, UC44, UC47, UC53, UC56, UC60, UC62, UC67, UC71, UC77, UC82, UC84, UC89, UC92, UC93 — 28 UCs.

63 + 10 + 14 + 28 = 115. Matches the UC→native-rung mapping in [vision-index.md](vision-index.md).
