# Links the canonical brainstorm-vision skill into this repo's local skills folder.
#
...
#
# Usage:  pwsh .\.claude\skills\link-brainstorm-vision.ps1

$ErrorActionPreference = 'Stop'

$source = 'C:\PROJ\ai-knowhow\skills-plugins\brainstorm-vision'
$link   = Join-Path $PSScriptRoot 'brainstorm-vision'
